...
def main():
    ...
    run([*common, '--network=none', image, 'python', '-m', 'django', 'test',
         ...
         'gadmin.products.tests.test_quality.ProductQualityRecordingTests',
         ...
         'gadmin.products.tests.test_sft.ReviewedFeedbackTests.test_default_assignment_only_confirms_the_link',
         'gadmin.products.tests.test_sft.ReviewedFeedbackTests.test_negative_review_exports_to_lora_but_not_pair_matcher',
         'gadmin.products.tests.test_sft.ReviewedFeedbackTests.test_latest_operator_correction_wins_for_the_same_title',
